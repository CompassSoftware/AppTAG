class two_lesson extends Phaser.Scene {
  ...
  update(delta) {
    ...
    if (this.puzzleActive == true && this.activatedQuiz == false && this.key_E.isDown) {
      this.activateQuiz();
      this.activatedQuiz = true;
    }

    if (this.puzzleActive == true && this.key_Q.isDown && this.activatedQuiz == true) {
      this.quitQuiz();
      this.activatedQuiz = false;
    }
...
*///////////////////////////////////////////////////////////////////////////////////////////////
  ...
  */
  loadAssets() {
	this.load.image('pressr_2', 'assets/pressr.png');
    ...
    this.load.image('floor_2', 'assets/floor_2.jpeg');
  ...
  */
  createImages() {
    ...
    this.floor_2 = this.add.image(768, 432, 'floor_2');
...
*/
  ...
  */
  setRotations() {
    this.wall_info_4.angle = 180;
    this.wall_info_5.angle = 180;
    this.wall_info_6.angle = 180;
  }
